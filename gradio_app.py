...
from brain_of_the_doctor import encode_image, analyze_image_with_query
from voice_of_the_patient import record_audio, transcribe_with_groq
from voice_of_the_doctor import text_to_speech  # ✅ only gTTS version
...
def process_inputs(audio_filepath, image_filepath):
    ...
    # Step 3: Convert doctor's response to voice
    output_audio_path = "final_doctor_voice.mp3"
    text_to_speech(input_text=doctor_response, output_filepath=output_audio_path)
